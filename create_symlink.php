<?php
// create_symlink.php
// Visit this file once on your live server (e.g. https://www.rtchocos.com/create_symlink.php)
// to link your uploads folder outside public_html. This prevents Git deployment from deleting images.
...
$symlinkPath = $docRoot . '/assets/blogs';
...
if (symlink($safeUploadsDir, $symlinkPath)) {
    ...
    echo "<p style='color:red;'><b>IMPORTANT: Now delete create_symlink.php from your server for security!</b></p>";
} else {
